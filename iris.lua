...
local function req(module)
	return getgenv().Modules[module]()
end

local function widget(module)
	return getgenv().Widgets[module]()
end

------------------------------------------------

print('Iris gigapizdec edition')
print('loading modules...')

------------------------------------------------

getgenv().Modules.WidgetTypes = function()
	--[=[
    @within Iris
    @type ID string
]=]
...
print('- WidgetTypes module loaded')

getgenv().Modules.Types = function()
	local WidgetTypes = req('WidgetTypes')
...
getgenv().Modules.API = function()
	local Types = req('Types')
...
getgenv().Modules.Internal = function()
...
getgenv().Modules.PubTypes = function()
	local Types = req('Types')
...
print('- PubTypes module loaded')

getgenv().Modules.config = function()
...
getgenv().Modules.demoWindow = function()
	local Types = req('Types')
...
print('- demoWindow module loaded')

------------------------------------------------

getgenv().Modules.widgets = function()
	local Types = req('Types')
...
return function(Iris: Types.Internal)
    ...
    widget('Root')(Iris, widgets)

    widget('Window')(Iris, widgets)

    widget('Menu')(Iris, widgets)

    widget('Format')(Iris, widgets)

    widget('Text')(Iris, widgets)
    widget('Button')(Iris, widgets)
    widget('Checkbox')(Iris, widgets)
    widget('RadioButton')(Iris, widgets)
    widget('Image')(Iris, widgets)

    widget('Tree')(Iris, widgets)
    widget('Tab')(Iris, widgets)

    widget('Input')(Iris, widgets)
    widget('Combo')(Iris, widgets)
    widget('Plot')(Iris, widgets)
    
    widget('Table')(Iris, widgets)
end
...
getgenv().Widgets.Button = function()
	local Types = req('Types')
...
print('- Button widget loaded')

getgenv().Widgets.Checkbox = function()
    local Types = req('Types')
...
print('- Checkbox widget loaded')

getgenv().Widgets.Combo = function()
    local Types = req('Types')
...
print('- Combo widget loaded')

getgenv().Widgets.Format = function()
    local Types = req('Types')
...
print('- Format widget loaded')

getgenv().Widgets.Image = function()
    local Types = req('Types')
...
print('- Image widget loaded')

getgenv().Widgets.Input = function()
    local Types = req('Types')
...
print('- Image widget Input')

getgenv().Widgets.Menu = function()
    local Types = req('Types')
...
print('- Menu widget loaded')

getgenv().Widgets.Plot = function()
    local Types = req('Types')
...
print('- Plot widget loaded')

getgenv().Widgets.RadioButton = function()
    local Types = req('Types')
...
print('- RadioButton widget loaded')

getgenv().Widgets.Root = function()
    local Types = req('Types')
...
print('- Root widget loaded')

getgenv().Widgets.Tab = function()
    local Types = req('Types')
...
print('- Tab widget loaded')

getgenv().Widgets.Table = function()
    local Types = req('Types')
...
print('- Text widget loaded')

getgenv().Widgets.Tree = function()
    local Types = req('Types')
...
getgenv().Widgets.Window = function()
    local Types = req('Types')
...
print('- Window widget loaded')

------------------------------------------------

getgenv().Iris = function ()
	--!optimize 2
...
--[=[
	...
	local Internal: Types.Internal = req('Internal')(Iris)
...
--[=[
	...
	Iris.TemplateConfig = req('config')
...
--[=[
	...
	Iris.ShowDemoWindow = req('demoWindow')(Iris)

	req('widgets')(Internal)
	req('API')(Iris)
...
print('Iris initialized.\n\nUse getgenv().Iris().Init() to use Iris.')

------------------------------------------------

--local Iris = getgenv().Iris().Init()
